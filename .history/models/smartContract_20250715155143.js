...
const smartContractSchema = new mongoose.Schema({
  ...
  createdBy: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth', required: true }, // ID of the user who created the contract
  updatedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth', required
: true }, // ID of the user who last updated the contract
  updatedAt: {
    type: Date,
    default: Date.now,
  },
