...
const subscriptionSchema = new mongoose.Schema({
  ...
  paymentMethod: { type: String, enum: ['Card', 'PayPal', 'Bank Transfer'], default: 'Card' }, // Payment method used
  ...
  resumedByRole: { type: String, enum: ['associate', 'client'], required: true }, // Role of the user who resumed the subscription  
  cancelledByRole: { type: String, enum: ['associate', 'client'], required: true }, // Role of the user who cancelled the subscription
  expiredByRole: { type: String, enum: ['associate', 'client'], required: true }, // Role of the user who expired the subscription
  pausedById: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth',
    required: true // ID of the user who paused the subscription
  }, 
  resumedById: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth',
    required: true // ID of the user who resumed the subscription
  },
  cancelledById: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth',
    required: true // ID of the user who cancelled the subscription
  },
  expiredById: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth',
    required: true // ID of the user who expired the subscription
  },
  updatedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth', required: true }, // ID of the user who last updated the subscription
  updatedByRole: { type: String, enum: ['associate', 'client'], required: true }, // Role of the user who last updated the subscription
  updatedById: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth', required: true }, // ID of the user who last updated the subscription
  updatedAt: { type: Date, default: Date.now }, // Timestamp of the last
  createdBy: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth', required: true }, // User who created the subscription
  createdByRole: { type: String, enum: ['associate', 'client'], required: true }, // Role of the user who created the subscription
  createdById: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth',
