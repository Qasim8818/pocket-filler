...
const projectSchema = new mongoose.Schema({
  ...
  contractId: { type: mongoose.Schema.Types.ObjectId, ref: 'Contract', required
: true },
  associateId: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth', required: true },
  projectManagerId: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth', required: true },
  projectType: { type: String, enum: ['Internal', 'External'], required:
  true },
  projectStatus: { type: String, enum: ['Active', 'On Hold', 'Completed', 'Cancelled'], required: true },
  ...
  archivedByRole: { type: String, enum: ['associate', 'client'], required: true }, // Role of the user who archived the project
  deletedByRole: { type: String, enum: ['associate', 'client'], required: true }, // Role of the user who deleted the project
  archivedById: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth', required: true }, // ID of the user who archived the project
  deletedById: { type: mongoose.Schema.Types.ObjectId, ref: 'Auth', required: true }, // ID of the user who deleted the project 
